...
export default {
	...
	methods: {
		...
		showLines() {
			this.createLayer("lineLayer", "lineLayer", (e) => {
				console.log(e);
			});
			this.createLayer("lineLayers", "lineLayers", (e) => {
				console.log(e);
			});
			// 所有的点都是统一的样式
			this._map.showOneStyleLines(
				[
					[
						[113.137599, 23.031483],
					...
					{
						line: [
							[113.134599, 23.521483],
							[113.135599, 23.021483],
							[113.134699, 23.021483],
						],
						data: {
							value: "test",
							click: () => {},
			...
			this._map.showMoerStyleLines(
				[
					// 第一组点
					{
						...
						lines: [
							[
								[113.117599, 23.031483],
								[113.114599, 23.031483],
								[113.115599, 23.031483],
								[113.116599, 23.031483],
							],
							{
								line: [
									[113.118599, 23.031483],
									[113.119599, 23.031483],
									[113.120599, 23.031483],
									[113.121599, 23.031483],
								],
								data: {
									value: "test",
									click: () => {},
					...
					},
					{
						...
						lines: [
							[
								[113.185599, 23.131483],
								[113.184599, 23.131483],
								[113.183599, 23.131483],
								[113.182599, 23.131483],
							],
							{
								line: [
									[113.155599, 23.131483],
									[113.154599, 23.131483],
									[113.185299, 23.131483],
									[113.185199, 23.131483],
								],
								data: {
									value: "test",
									click: () => {},
		...
		showClustePoint() {
			this.dataLayer.ClusterLayer = this._map.createClusterLayer(
				"ClusterLayer",
				{
					// clusterStyleOptions: {},
				},
